<div class="row">
    ...
    if (isset($msg)):
        ?>
        <div class="alert alert-success col-md-7"> <?= $msg ?>. </div>
    <?php endif; ?>
</div>
...
<div class="container">
    ...
    <div class="col-lg-12">
        ...
        <form role="form" method="post" class="form-inline" action="<?php echo base_url(); ?>marks/marks_controller/disablestudents" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <br>
                <button type="submit" class="btn btn-primary m-t-xs bottom15-xs"><?= ((isset($formBtn)) ? $formBtn : "Upload marks") ?></button>
            </div>
        </form>
    </div>
</div>
