$(function() {
    ...
    jQuery('.chart-input1').off().on('input change', function() {
...
$(function() {
    ...
    jQuery('.chart-input3').off().on('input change', function() {
        var property = jQuery(this).data('property');
        var target = chart;
        chart.startDuration = 0;
...
var chart = AmCharts.makeChart("chartValueAxis", {
    "type": "serial",
    "theme": "light",
    "legend": {
        "equalWidths": false,
...
var chart = AmCharts.makeChart("ganttChart", {
    "type": "gantt",
    "theme": "light",
    "marginRight": 70,
    "period": "hh",
...
var chart = AmCharts.makeChart("simplePieChart", {
    "type": "pie",
    "theme": "light",
    "dataProvider": [{
        "country": "Lithuania",
...
var chart = AmCharts.makeChart("Bar-line", {
    "type": "serial",
    "theme": "light",
    "handDrawn": true,
    "handDrawScatter": 3,
...
// Pyramid Chart
var chart = AmCharts.makeChart("pyramidChart", {
    "type": "funnel",
    "theme": "light",
    "dataProvider": [{
...
var chart = AmCharts.makeChart("polarChart", {
    "type": "radar",
    "theme": "light",
    "dataProvider": [{
        "direction": "N",
...
window.map = AmCharts.makeChart("flightRoutes", {
    type: "map",
    "theme": "light",
    dataProvider: {
        map: "worldLow",
...
var chart = AmCharts.makeChart("DateBasedData", {
    "type": "serial",
    "theme": "light",
    "marginRight": 40,
    "marginLeft": 40,
...
// Line Changing Color
var chart = AmCharts.makeChart("LineChangingColor", {
    "type": "serial",
    "theme": "light",
    "marginRight": 80,
    "dataProvider": [{
...
var chart = AmCharts.makeChart("trendLines", {
    "type": "serial",
    "theme": "light",
    "marginRight": 80,
    "autoMarginOffset": 20,
    ...
    "chartScrollbar": {
        ...
        "selectedBackgroundColor": "#29aba4",
...
chart.addListener("dataUpdated", zoomChart4);
